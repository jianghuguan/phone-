...
window.widgetApp = {
    ...
    setup: function() {
        ...
        const widgets = Vue.computed(function() {
            return store.desktopItems.filter(function(item) { return item.type === 'widget'; });
        });
        ...
        const removeWidget = function(id) {
            store.desktopItems = store.desktopItems.filter(function(item) { return item.id !== id; });
        };
        ...
        const handleImageUpload = function(event, id) {
            ...
            reader.onload = function(e) {
                ...
                img.onload = function() {
                    ...
                    const targetWidget = store.desktopItems.find(function(item) { return item.id === id; });
                    if (targetWidget) {
